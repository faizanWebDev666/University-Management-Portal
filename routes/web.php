...
Route::middleware(['session.inactivity'])->group(function () {
    ...
    Route::get('/admin/users/search', [AdminSearchController::class, 'ajaxFilterUsers'])->name('admin.users.search');
    ...
    Route::get('admin/permissions', [AdminPermissionController::class, 'index'])->middleware('adminauth')->name('admin.permissions.index');
    Route::post('admin/permissions', [AdminPermissionController::class, 'update'])->middleware('adminauth')->name('admin.permissions.update');
    ...
    Route::post('/faculty/assignments/{assignmentId}/update-meta', [AssignmentController::class, 'updateMeta'])->name('assignments.updateMeta');
    ...
    Route::post('/faculty/quizzes/upload', [QuizzesController::class, 'store'])->name('quizzes.store');
    Route::post('/faculty/quizzes/{quizId}/update-timeline', [QuizzesController::class, 'updateTimeline'])->name('quizzes.updateTimeline');
    Route::get('/teacher/quiz/{quizId}/submissions', [QuizzesController::class, 'viewSubmissions'])->name('faculity.showquiz');


    // Marks Management Routes (for AJAX loading)
    Route::get('/faculty/assignments/{assignmentId}/submissions', [AssignmentController::class, 'viewSubmissions']);
    Route::post('/faculty/assignments/{assignmentId}/marks', [AssignmentController::class, 'storeMarks'])->name('assignments.storeMarks');

    Route::get('/faculty/quizzes/{quizId}/submissions', [QuizzesController::class, 'viewSubmissions']);
    Route::post('/faculty/quizzes/{quizId}/marks', [QuizzesController::class, 'storeMarks'])->name('quizzes.storeMarks');
