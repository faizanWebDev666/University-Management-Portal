...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/dashboard/candidate-dashboard-settings(pass-change).html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:42:11 GMT -->
<head>
	<meta charset="UTF-8">
		...
		<aside class="dash-aside-navbar">
			<div class="position-relative">
				...
				<nav class="dasboard-main-nav">
					<ul class="style-none">
						<li><a href="candidate-dashboard-index.html" class="d-flex w-100 align-items-center">
						...
						<li><a href="candidate-dashboard-settings.html" class="d-flex w-100 align-items-center active">
				...
				<div class="bg-white card-box border-20">
                    <form action="#">
                        ...
                        <div class="button-group d-inline-flex align-items-center">
                            <a href="#" class="dash-btn-two tran3s rounded-3">Save & Updated</a>
                        </div>	
                    </form>
                </div>
				<!-- /.card-box -->				
