...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/dashboard/candidate-dashboard-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:42:10 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="position-relative">
				...
				<nav class="dasboard-main-nav">
					<ul class="style-none">
						...
						<li><a href="candidate-dashboard-profile.html" class="d-flex w-100 align-items-center active">
							<img src="../images/lazy.svg" data-src="images/icon/icon_2_active.svg" alt="" class="lazy-img">
