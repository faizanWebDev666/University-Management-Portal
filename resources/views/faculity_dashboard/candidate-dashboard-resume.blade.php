...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/dashboard/candidate-dashboard-resume.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:42:11 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<nav class="dasboard-main-nav">
					<ul class="style-none">
						...
						<li><a href="#" class="d-flex w-100 align-items-center active">
							<img src="../images/lazy.svg" data-src="images/icon/icon_3_active.svg" alt="" class="lazy-img">
							<span>Resume</span>
						</a></li>
