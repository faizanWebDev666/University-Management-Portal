...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/dashboard/employer-dashboard-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:42:10 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="position-relative">
				...
				<nav class="dasboard-main-nav">
					<ul class="style-none">
						...
						<li><a href="employer-dashboard-settings.html" class="d-flex w-100 align-items-center active">
							<img src="../images/lazy.svg" data-src="images/icon/icon_7_active.svg" alt="" class="lazy-img">
...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/dashboard/employer-dashboard-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:42:11 GMT -->
</html>