...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/candidates-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:42:07 GMT -->
<head>
	<meta charset="UTF-8">
						...
						<div class="position-relative">
                            ...
                            <div class="accordion-box grid-style show">
                                <div class="row">
									...
									<div class="col-xxl-3 col-lg-4 col-sm-6 d-flex">
                                        <div class="candidate-profile-card favourite text-center grid-layout border-0 mb-25">
											<a href="candidate-profile-v1.html" class="save-btn tran3s"><i class="bi bi-heart"></i></a>
                                        	<div class="cadidate-avatar position-relative d-block m-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_06.jpg" alt="" class="lazy-img rounded-circle"></a></div>
									...
									<div class="col-xxl-3 col-lg-4 col-sm-6 d-flex">
                                        <div class="candidate-profile-card text-center grid-layout border-0 mb-25">
											<a href="candidate-profile-v1.html" class="save-btn tran3s"><i class="bi bi-heart"></i></a>
                                        	<div class="cadidate-avatar online position-relative d-block m-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_02.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										   <h4 class="candidate-name mt-15 mb-0"><a href="candidate-profile-v1.html" class="tran3s">Juan Marko</a></h4>
										   <div class="candidate-post">Marketing Expert</div>
										   <ul class="cadidate-skills style-none d-flex flex-wrap align-items-center justify-content-center justify-content-md-between pt-30 sm-pt-20 pb-10">
												<li>Java</li>
									...
									<div class="col-xxl-3 col-lg-4 col-sm-6 d-flex">
                                        <div class="candidate-profile-card text-center grid-layout border-0 mb-25">
											<a href="candidate-profile-v1.html" class="save-btn tran3s"><i class="bi bi-heart"></i></a>
                                        	<div class="cadidate-avatar position-relative d-block m-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_07.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										   <h4 class="candidate-name mt-15 mb-0"><a href="candidate-profile-v1.html" class="tran3s">Juliana Shofie</a></h4>
										   <div class="candidate-post">Data Entry</div>
										   <ul class="cadidate-skills style-none d-flex flex-wrap align-items-center justify-content-center justify-content-md-between pt-30 sm-pt-20 pb-10">
												<li>Data</li>
									...
									<div class="col-xxl-3 col-lg-4 col-sm-6 d-flex">
                                        <div class="candidate-profile-card favourite text-center grid-layout border-0 mb-25">
											<a href="candidate-profile-v1.html" class="save-btn tran3s"><i class="bi bi-heart"></i></a>
                                        	<div class="cadidate-avatar online position-relative d-block m-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_08.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										   <h4 class="candidate-name mt-15 mb-0"><a href="candidate-profile-v1.html" class="tran3s">Julia Ark</a></h4>
										   <div class="candidate-post">Graphic Designer</div>
										   <ul class="cadidate-skills style-none d-flex flex-wrap align-items-center justify-content-center justify-content-md-between pt-30 sm-pt-20 pb-10">
												<li>Design</li>
									...
									<div class="col-xxl-3 col-lg-4 col-sm-6 d-flex">
                                        <div class="candidate-profile-card text-center grid-layout border-0 mb-25">
											<a href="candidate-profile-v1.html" class="save-btn tran3s"><i class="bi bi-heart"></i></a>
                                        	<div class="cadidate-avatar online position-relative d-block m-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_09.jpg" alt="" class="lazy-img rounded-circle"></a></div>
							...
							<div class="accordion-box list-style">
								<div class="candidate-profile-card favourite list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar online position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_01.jpg" alt="" class="lazy-img rounded-circle"></a></div>
								...
								<div class="candidate-profile-card favourite list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar online position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_03.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
								...
								<div class="candidate-profile-card list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_02.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
								...
								<div class="candidate-profile-card list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar online position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_04.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
								...
								<div class="candidate-profile-card favourite list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar online position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_05.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
								...
								<div class="candidate-profile-card favourite list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_06.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
								...
								<div class="candidate-profile-card list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_07.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
								...
								<div class="candidate-profile-card favourite list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar online position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_08.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
								...
								<div class="candidate-profile-card list-layout border-0 mb-25">
									<div class="d-flex">
										<div class="cadidate-avatar online position-relative d-block me-auto ms-auto"><a href="candidate-profile-v1.html" class="rounded-circle"><img src="images/lazy.svg" data-src="images/candidates/img_09.jpg" alt="" class="lazy-img rounded-circle"></a></div>
										<div class="right-side">
											<div class="row gx-1">
												<div class="col-xl-4">
													<div class="position-relative">
