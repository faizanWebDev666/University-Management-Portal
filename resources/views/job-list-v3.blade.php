...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/job-list-v3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:41:58 GMT -->
<head>
	<meta charset="UTF-8">
											...
											<div class="main-wrapper h-100 w-100">
                                                ...
                                                <div class="list-header d-flex align-items-center">
                                                    ...
                                                    <div class="info-wrapper">
                                                        <a href="job-details-v2.html" class="title fw-500 tran3s">Developer & expert in java c++</a>
                                                ...
                                                <!-- ./.list-header -->
                                                <p>We would like to design a page on Figma to promote Workroom as All-in-one solutions for Marketing, Sales, Support teams...</p>
                                                <div class="d-sm-flex align-items-center justify-content-between mt-auto">
                                                    <div class="d-flex align-items-center">
                                                        <img src="images/icon/icon_51.svg" alt="">
                                                        <span class="fw-500 client-status">Verified Client  .</span>
                                                        <a href="job-details-v2.html" class="job-duration fw-500">Fulltime</a>
                                                    </div>
                                                    <a href="job-details-v2.html" class="apply-btn text-center tran3s xs-mt-20">APPLY</a>
                                                </div>
                                            </div>
										</div> <!-- /.job-list-three -->
									</div>
										...
										<div class="job-list-three d-flex h-100 w-100">
											<div class="main-wrapper h-100 w-100">
                                                ...
                                                <div class="list-header d-flex align-items-center">
                                                    ...
                                                    <div class="info-wrapper">
                                                        <a href="job-details-v2.html" class="title fw-500 tran3s">Marketing Specialist in SEO</a>
                                                        <ul class="style-none d-flex flex-wrap info-data">
                                                            <li>$300-$500/week</li>
                                                            <li>Expert</li>
                                                            <li>USA, New York</li>
										...
										<div class="job-list-three d-flex h-100 w-100">
											<div class="main-wrapper h-100 w-100">
                                                ...
                                                <div class="list-header d-flex align-items-center">
                                                    ...
                                                    <div class="info-wrapper">
                                                        <a href="job-details-v2.html" class="title fw-500 tran3s">Email Marketing & App Integrations</a>
                                                        <ul class="style-none d-flex flex-wrap info-data">
                                                            <li>$1k-$1.5k/month</li>
                                                            <li>Beginner</li>
                                                            <li>USA, Alaska</li>
										...
										<div class="job-list-three d-flex h-100 w-100">
											<div class="main-wrapper h-100 w-100">
                                                ...
                                                <div class="list-header d-flex align-items-center">
                                                    ...
                                                    <div class="info-wrapper">
                                                        <a href="job-details-v2.html" class="title fw-500 tran3s">Outbound Call Service Webshop</a>
                                                        <ul class="style-none d-flex flex-wrap info-data">
                                                            <li>$30-$50/hour</li>
                                                            <li>Intermediate</li>
                                                            <li>Spain, Barcelona  </li>
										...
										<div class="job-list-three d-flex h-100 w-100">
											<div class="main-wrapper h-100 w-100">
                                                ...
                                                <div class="list-header d-flex align-items-center">
                                                    ...
                                                    <div class="info-wrapper">
                                                        <a href="job-details-v2.html" class="title fw-500 tran3s">Build Responsive Website From Scratch</a>
                                                        <ul class="style-none d-flex flex-wrap info-data">
                                                            <li>$20-$25/hourr</li>
                                                            <li>Intermediate</li>
										...
										<div class="job-list-three d-flex h-100 w-100">
											<div class="main-wrapper h-100 w-100">
                                                ...
                                                <div class="list-header d-flex align-items-center">
                                                    ...
                                                    <div class="info-wrapper">
                                                        <a href="job-details-v2.html" class="title fw-500 tran3s">Document typing (easy typing)</a>
                                                        <ul class="style-none d-flex flex-wrap info-data">
                                                            <li>$200-$250/week</li>
                                                            <li>Beginner</li>
										...
										<div class="job-list-three d-flex h-100 w-100">
											<div class="main-wrapper h-100 w-100">
                                                ...
                                                <div class="list-header d-flex align-items-center">
                                                    ...
                                                    <div class="info-wrapper">
                                                        <a href="job-details-v2.html" class="title fw-500 tran3s">General Ledger & Marketing Specialist</a>
                                                        <ul class="style-none d-flex flex-wrap info-data">
                                                            <li>$60k-$70k/year</li>
                                                            <li>Expert</li>
                                                            <li>UK, London</li>
