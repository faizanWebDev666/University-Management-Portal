...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/blog-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:41:50 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-md-6">
                                <article class="blog-meta-two mb-60 lg-mb-40">
                                    <figure class="post-img m0">
                                        <a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_18.jpg" alt="" class="lazy-img w-100 tran4s"></a>
                                        <a href="blog-details.html" class="tags color-two fw-500">Solution</a>
                                    </figure>
                                    <div class="post-data mt-35 lg-mt-20">
                                        <div class="date"><span class="fw-500 text-dark">Featured -</span> <a href="blog-details.html">18 Jul 2022</a></div>
                                        <a href="blog-details.html"><h4 class="tran3s blog-title xs">Print, publishing qui visual quis layout mockups.</h4></a>
                                        <a href="blog-details.html" class="continue-btn tran3s d-flex align-items-center">
                            ...
                            <div class="col-md-6">
                                <article class="blog-meta-two mb-60 lg-mb-40">
                                    <figure class="post-img m0">
                                        <a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_19.jpg" alt="" class="lazy-img w-100 tran4s"></a>
                                        <a href="blog-details.html" class="tags color-two fw-500">DESIGN</a>
                                    </figure>
                                    <div class="post-data mt-35 lg-mt-20">
                                        <div class="date"><a href="blog-details.html">18 Jul 2022</a></div>
                                        <a href="blog-details.html"><h4 class="tran3s blog-title xs">Designer checklist for every UX/UI project.</h4></a>
                                        <a href="blog-details.html" class="continue-btn tran3s d-flex align-items-center">
                                            <span class="fw-500 me-2">Continue Reading</span>
                                            <i class="bi bi-arrow-right"></i>
                                        </a>
                            ...
                            <div class="col-md-6">
                                <article class="blog-meta-two mb-60 lg-mb-40">
                                    <figure class="post-img m0">
                                        <a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_20.jpg" alt="" class="lazy-img w-100 tran4s"></a>
                                        <a href="blog-details.html" class="tags color-two fw-500">Business</a>
                                    </figure>
                                    <div class="post-data mt-35 lg-mt-20">
                                        <div class="date"><a href="blog-details.html">18 Jul 2022</a></div>
                                        <a href="blog-details.html"><h4 class="tran3s blog-title xs">Make more productive working flow daily.</h4></a>
                                        <a href="blog-details.html" class="continue-btn tran3s d-flex align-items-center">
                                            <span class="fw-500 me-2">Continue Reading</span>
                                            <i class="bi bi-arrow-right"></i>
                                        </a>
                            ...
                            <div class="col-md-6">
                                <article class="blog-meta-two mb-60 lg-mb-40">
                                    <figure class="post-img m0">
                                        <a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_21.jpg" alt="" class="lazy-img w-100 tran4s"></a>
                                        <a href="blog-details.html" class="tags color-two fw-500">Branding</a>
                                    </figure>
                                    <div class="post-data mt-35 lg-mt-20">
                                        <div class="date"><span class="fw-500 text-dark">Featured -</span> <a href="blog-details.html">18 Jul 2022</a></div>
                                        <a href="blog-details.html"><h4 class="tran3s blog-title xs">Quis nostrud exercitation ullamco laboris nisi.</h4></a>
                                        <a href="blog-details.html" class="continue-btn tran3s d-flex align-items-center">
                                            <span class="fw-500 me-2">Continue Reading</span>
                                            <i class="bi bi-arrow-right"></i>
                                        </a>
                            ...
                            <div class="col-md-6">
                                <article class="blog-meta-two mb-60 lg-mb-40">
                                    <figure class="post-img m0">
                                        <a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_22.jpg" alt="" class="lazy-img w-100 tran4s"></a>
                                        <a href="blog-details.html" class="tags color-two fw-500">Marketing</a>
                                    </figure>
                                    <div class="post-data mt-35 lg-mt-20">
                                        <div class="date"><a href="blog-details.html">18 Jul 2022</a></div>
                                        <a href="blog-details.html"><h4 class="tran3s blog-title xs">Make Your WordPress
                                            dus Journal.</h4></a>
                                        <a href="blog-details.html" class="continue-btn tran3s d-flex align-items-center">
                                            <span class="fw-500 me-2">Continue Reading</span>
                                            <i class="bi bi-arrow-right"></i>
                            ...
                            <div class="col-md-6">
                                <article class="blog-meta-two mb-60 lg-mb-40">
                                    <figure class="post-img m0">
                                        <a href="blog-details.html" class="w-100 d-block"><img src="images/lazy.svg" data-src="images/blog/blog_img_23.jpg" alt="" class="lazy-img w-100 tran4s"></a>
                                        <a href="blog-details.html" class="tags color-two fw-500">DESIGN</a>
                                    </figure>
                                    <div class="post-data mt-35 lg-mt-20">
                                        <div class="date"><a href="blog-details.html">18 Jul 2022</a></div>
                                        <a href="blog-details.html"><h4 class="tran3s blog-title xs">Speaking remotely at WordCamp US.</h4></a>
                                        <a href="blog-details.html" class="continue-btn tran3s d-flex align-items-center">
                                            <span class="fw-500 me-2">Continue Reading</span>
                                            <i class="bi bi-arrow-right"></i>
                                        </a>
						...
						<div class="blog-sidebar ps-xl-4 md-mt-60">
							...
							<div class="category-list mb-60 lg-mb-40">
								...
								<ul class="style-none">
									...
									<li><a href="#">Interview (2)</a></li>
									<li><a href="#">Speaking (8)</a></li>
									<li><a href="#">Skill (5)</a></li>
							...
							<div class="sidebar-recent-news mb-60 lg-mb-40">
								...
								<div class="news-block d-flex align-items-center pt-20 pb-20 border-top">
									<div><img src="images/lazy.svg" data-src="images/blog/blog_img_15.jpg" alt="" class="lazy-img"></div>
									<div class="post ps-4">
										<h4 class="mb-5"><a href="blog-details.html" class="title tran3s">10 days quick challange forboost visitors.</a></h4>
										<div class="date">23 July, 2022</div>
									</div>
								</div>
								<div class="news-block d-flex align-items-center pt-20 pb-20 border-top">
									<div><img src="images/lazy.svg" data-src="images/blog/blog_img_16.jpg" alt="" class="lazy-img"></div>
									<div class="post ps-4">
										<h4 class="mb-5"><a href="blog-details.html" class="title tran3s">Easy way to boost your business.</a></h4>
										<div class="date">23 July, 2022</div>
									</div>
								</div>
								<div class="news-block d-flex align-items-center pt-20 pb-20 border-top border-bottom">
									<div><img src="images/lazy.svg" data-src="images/blog/blog_img_17.jpg" alt="" class="lazy-img"></div>
									<div class="post ps-4">
										<h4 class="mb-5"><a href="blog-details.html" class="title tran3s">Introducing new tools for your design.</a></h4>
										<div class="date">23 July, 2022</div>
									</div>
								</div>
							</div>
