...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/job-grid-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:41:50 GMT -->
<head>
	<meta charset="UTF-8">
                            ...
                            <div class="accordion-box list-style">
                                    ...
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_22.png" alt="" class="lazy-img m-auto"></a>
								...
								<div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_23.png" alt="" class="lazy-img m-auto"></a>
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_24.png" alt="" class="lazy-img m-auto"></a>
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_25.png" alt="" class="lazy-img m-auto"></a>
                                                <a href="job-details-v2.html" class="title fw-500 tran3s ps-3 ps-lg-0">Developer & expert in java c++</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_26.png" alt="" class="lazy-img m-auto"></a>
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_33.png" alt="" class="lazy-img m-auto"></a>
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_34.png" alt="" class="lazy-img m-auto"></a>
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_35.png" alt="" class="lazy-img m-auto"></a>
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_36.png" alt="" class="lazy-img m-auto"></a>
                                ...
                                <div class="job-list-one style-two position-relative border-style mb-20">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-xl-3 col-lg-4">
                                            <div class="job-title d-flex align-items-center">
                                                <a href="job-details-v2.html" class="logo md-mb-20"><img src="images/lazy.svg" data-src="images/logo/media_37.png" alt="" class="lazy-img m-auto"></a>
