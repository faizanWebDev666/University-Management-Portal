                    ...
                    <ul class="right_chat list-unstyled list">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../backend/images/xs/avatar1.jpg" alt="">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../backend/images/xs/avatar7.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../backend/images/xs/avatar8.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../backend/images/xs/avatar9.jpg" alt="">
                                <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="../backend/images/xs/avatar10.jpg" alt="">
                                <div class="media-body">
                    ...
                    <div class="chat_windows">
                        <ul class="mb-0">
                            <li class="other-message">
                                <img class="avatar mr-3" src="../backend/images/xs/avatar1.jpg" alt="avatar">
                                <div class="message">
                            ...
                            <li class="other-message">
                                ...
                                <div class="message">
                                    <div class="media_img">
                                        <img src="../backend/images/gallery/1.jpg" class="w100 img-thumbnail" alt="">
                                        <img src="../backend/images/gallery/2.jpg" class="w100 img-thumbnail" alt="">
                                    </div>
                                    <span class="time">10:15 AM, Today</span>
                                </div>
                            </li> 
