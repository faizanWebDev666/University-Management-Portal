...
<!-- Mirrored from puffintheme.com/themeforest/ericsson/university/hostel.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jun 2025 05:18:17 GMT -->
<head>
<meta charset="UTF-8">
            ...
            <div class="tab-pane fade show active" id="menu-admin" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li class="active"><a href="hostel.html"><i class="fa fa-bed"></i><span>Hostel</span></a></li>
