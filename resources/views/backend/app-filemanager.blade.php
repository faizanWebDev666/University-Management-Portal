...
<!-- Mirrored from puffintheme.com/themeforest/ericsson/university/app-filemanager.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jun 2025 05:17:58 GMT -->
<head>
<meta charset="UTF-8">
            ...
            <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
                <nav class="sidebar-nav">
                    <ul class="metismenu">
                        ...
                        <li class="active"><a href="app-filemanager.html"><i class="fa fa-folder"></i><span>FileManager</span></a></li>
                                    ...
                                    <table class="table table-hover table-vcenter table_custom text-nowrap spacing5 text-nowrap mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="folder-name">report-2023.pdf</span>
                                                </td>
                                                <td>
                                                    -
                                                </td>
