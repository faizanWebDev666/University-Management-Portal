...
<!-- Mirrored from puffintheme.com/themeforest/ericsson/university/courses-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Jun 2025 05:18:25 GMT -->
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<meta http-equiv="X-UA-Compatible" content="ie=edge">
<link rel="icon" href="favicon.ico" type="image/x-icon"/>
<title>:: Ericsson :: Courses Details</title>
            ...
            <div class="card-body">
                <ul class="list-group list-unstyled">
                    <li class="list-group-item mb-2">
                        <p>Light Version</p>
                        <a href="index.html"><img src="../assets/images/themes/default.png" class="img-fluid" alt="" /></a>
                    </li>
                    <li class="list-group-item mb-2">
                        <p>Dark Version</p>
                        <a href="https://puffintheme.com/themeforest/ericsson/university-dark/index.html"><img src="../assets/images/themes/dark.png" class="img-fluid" alt="" /></a>
                    </li>
                    <li class="list-group-item mb-2">
                        <p>RTL Version</p>
                        <a href="https://puffintheme.com/themeforest/ericsson/university-rtl/index.html"><img src="../assets/images/themes/rtl.png" class="img-fluid" alt="" /></a>
                    </li>
                </ul>
            </div>
        </div>        
                    ...
                    <div class="right">
                        ...
                        <div class="notification d-flex">
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="https://puffintheme.com/themeforest/ericsson/assets/images/flags/us.svg" alt="">English</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="https://puffintheme.com/themeforest/ericsson/assets/images/flags/es.svg" alt="">Spanish</a>
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="https://puffintheme.com/themeforest/ericsson/assets/images/flags/jp.svg" alt="">japanese</a>
                                    <a class="dropdown-item" href="#"><img class="w20 mr-2" src="https://puffintheme.com/themeforest/ericsson/assets/images/flags/bl.svg" alt="">France</a>
                                </div>
                            </div>
                            <div class="dropdown d-flex">
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        <h1 class="page-title">Courses Details</h1>
                                ...
                                <table class="table table-striped table-vcenter mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right">21st Aug 2024</td>
                                        </tr>
                                        <tr>
                                            <td class="w20"><i class="fa fa-calendar text-blue"></i></td>
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">Microsoft Application Tools such MS Word, MS Excel, MS PowerPoint. <span class="badge badge-primary badge-pill">1 Month</span></li>
                                    <li class="list-group-item">Computer Organizations and Operating Systems.</li>
                                    <li class="list-group-item">Programming in C.</li>
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">Introduction to Computer and Internet.</li>
                                    <li class="list-group-item">Microsoft Application Tools such MS Word, MS Excel, MS PowerPoint.</li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">Computer Organizations and Operating Systems.<span class="badge badge-primary badge-pill">6 Month</span></li>
                                    <li class="list-group-item">Programming in C.</li>
                                    <li class="list-group-item">Object Oriented Programming Languages such as C++/Java.</li>
                                    <li class="list-group-item">RDBMS and Data Management</li>
                                    <li class="list-group-item">Web Technologies such as creation of dynamic website.</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 text-md-right">
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a href="https://puffintheme.com/themeforest/ericsson/doc/index.html">Documentation</a></li>
