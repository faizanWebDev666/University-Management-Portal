                                        ...
                                        <table class="table card-table table-vcenter text-nowrap table-striped mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w40">
                                                        <div class="avatar">
                                                            <img class="avatar" src="../backend/images/xs/avatar1.jpg" alt="avatar">
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w40">
                                                        <div class="avatar">
                                                            <img class="avatar" src="../backend/images/xs/avatar2.jpg" alt="avatar">
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w40">
                                                        <div class="avatar">
                                                            <img class="avatar" src="../backend/images/xs/avatar3.jpg" alt="avatar">
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w40">
                                                        <div class="avatar">
                                                            <img class="avatar" src="../backend/images/xs/avatar4.jpg" alt="avatar">
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w40">
                                                        <div class="avatar">
                                                            <img class="avatar" src="../backend/images/xs/avatar5.jpg" alt="avatar">
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w40">
                                                        <div class="avatar">
                                                            <img class="avatar" src="../backend/images/xs/avatar6.jpg" alt="avatar">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>Claire Peters</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w40">
                                                        <div class="avatar">
                                                            <img class="avatar" src="../backend/images/xs/avatar7.jpg" alt="avatar">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>Claire Peters</div>
                                        ...
                                        <table class="table table-hover text-nowrap table-striped table-vcenter mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="../backend/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <img src="../backend/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="tag tag-warning ml-0 mr-0">MED</span></td>
                                                    <td>
                                                        <img src="../backend/images/xs/avatar3.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="tag tag-warning ml-0 mr-0">MED</span></td>
                                                    <td>
                                                        <img src="../backend/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="tag tag-warning ml-0 mr-0">MED</span></td>
                                                    <td>
                                                        <img src="../backend/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="avatar" data-original-title="Avatar Name">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
