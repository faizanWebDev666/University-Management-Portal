...
<!-- Mirrored from html.creativegigstf.com/jobi/jobi/job-details-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Mar 2025 18:42:07 GMT -->
<head>
	<meta charset="UTF-8">
					...
					<div class="col-xxl-9 col-xl-10 m-auto">
						<div class="details-post-data ps-xxl-4 pe-xxl-4">
							<ul class="job-meta-data-two d-flex flex-wrap justify-content-center justify-content-lg-between style-none">
                                ...
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="images/lazy.svg" data-src="images/icon/icon_53.svg" alt="" class="lazy-img m-auto icon">
                                    <span>Expertise</span>
                                    <div>Intermediate</div>
                                </div>
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="images/lazy.svg" data-src="images/icon/icon_54.svg" alt="" class="lazy-img m-auto icon">
                                    <span>Location</span>
                                    <div>Spain, Barcelona </div>
                                </div>
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="images/lazy.svg" data-src="images/icon/icon_55.svg" alt="" class="lazy-img m-auto icon">
                                    <span>Job Type</span>
                                    <div>Fulltime</div>
                                </div>
                                <div class="bg-wrapper bg-white text-center">
                                    <img src="images/lazy.svg" data-src="images/icon/icon_56.svg" alt="" class="lazy-img m-auto icon">
